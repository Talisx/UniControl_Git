...
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/UniControlSystem.exe
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = UniControlSystem_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = UniControlSystem_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/UniControlSystem.exe
...
DEFINES_STANDARD = -DMODEL=UniControlSystem -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)/UniControlSystem_ert_rtw/UniControlSystem.c $(MATLAB_ROOT)/rtw/c/src/common/rt_main.c
...
%.obj : $(START_DIR)/UniControlSystem_ert_rtw/%.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
